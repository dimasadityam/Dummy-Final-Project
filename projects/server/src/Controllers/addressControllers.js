...
module.exports = {
  ...
  editAddress: async (req, res) => {
    ...
    if (req.dataUser.idUser) {
      ...
      // EDIT ADDRESS & CITY ////////////////////
      // else if (req.body.label == '' && req.body.receiverName == '' && req.body.receiverPhone == '' && req.body.province == '' && req.body.postalCode == '') {
      //   if (req.body.isDefaultAddress == false) {
      //     let edit = await dbQuery(`UPDATE address SET address = '${req.body.address}', city = '${req.body.city}' WHERE idAddress=${req.body.idAddress};`)
      //     let resultsEdit = await dbQuery(`Select * FROM address WHERE idUser = ${req.dataUser.idUser};`);
      //     console.log("resultEdit alamat & kota", resultsEdit)
      ...
      //     console.log("checkUtama[0]", checkUtama[0])
      //     if (checkUtama[0] == undefined) {
      //       let edit = await dbQuery(`UPDATE address SET address = '${req.body.address}', city = '${req.body.city}', isDefaultAddress = '${req.body.isDefaultAddress}' WHERE idAddress=${req.body.idAddress};`)

      //       let resultsEdit = await dbQuery(`Select * FROM address WHERE idUser = ${req.dataUser.idUser};`);
      //       console.log("resultEdit alamat & kota undefined", resultsEdit)
      ...
      // EDIT ADDRESS, CITY & POSTALCODE ///////////////////
      // else if (req.body.label == '' && req.body.receiverName == '' && req.body.receiverPhone == '' && req.body.province == '') {
      //   if (req.body.isDefaultAddress == false) {
      //     let edit = await dbQuery(`UPDATE address SET address = '${req.body.address}', city = '${req.body.city}', postalCode = '${req.body.postalCode}' WHERE idAddress=${req.body.idAddress};`)
      //     let resultsEdit = await dbQuery(`Select * FROM address WHERE idUser = ${req.dataUser.idUser};`);
      //     console.log("resultEdit alamat, kota & kode pos", resultsEdit)
      ...
      //     console.log("checkUtama[0]", checkUtama[0])
      //     if (checkUtama[0] == undefined) {
      //       let edit = await dbQuery(`UPDATE address SET address = '${req.body.address}', city = '${req.body.city}', postalCode = '${req.body.postalCode}', isDefaultAddress = '${req.body.isDefaultAddress}' WHERE idAddress=${req.body.idAddress};`)

      //       let resultsEdit = await dbQuery(`Select * FROM address WHERE idUser = ${req.dataUser.idUser};`);
      //       console.log("resultEdit alamat, kota & kode pos undefined", resultsEdit)
