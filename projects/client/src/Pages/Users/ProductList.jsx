        ...
        <Box borderRadius={"10px"} width="165px" height="300px" boxShadow='lg' bg='#FFFFFF' mt={"25px"} ml={"20px"} >
          <div class="row">
            <div class="row d-flex justify-content-center">
              <Image src={obat1} width='150px' style={{marginLeft:"25px", marginTop:"5px", cursor:"pointer"}} onClick={()=> navigate("/productDetail")}/>
              <Box noOfLines={1} >
  ...
  return(
    ...
    <Box boxShadow='md'>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3">
            <Box borderRadius={"10px"} width="100%" height="500px" boxShadow='lg' bg='#FFFFFF' mt={"23px"} >
              <Box pt={"17px"} ms={"30px"}>
              ...
              <Divider mt={"30px"}/>
                ...
                <Box pt={"10px"} ms={"30px"} me={"30px"}>
                  <Input bgColor={"#FFFFFF"} boxShadow='md' placeholder="Search by name" />
                  <Box mt={"15px"}>
          ...
          <div class="col-md-9">
            <Flex mt={"40px"} ms={"20px"}>
              ...
              <Box>
                <Menu>
                  <MenuButton as={Button} boxShadow='lg' bg='#FFFFFF' me={"30px"} >
                    Sortir Product
                  </MenuButton>
